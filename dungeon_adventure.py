...
def main():
    ...
    def create_treasures():
                ...
                treasures = {
                    'bronze sword': 20,
                    'gold pieces' : 5,
                    'health potion' : random.randint(7, 20),
                    'spell casting potion' : 25,
                    'diamond' : 15,
                    'plated armor' : 35,
                    'bow and arrow' : 10,
                    'silver pieces' : 3,
    ...
    def search_room(player, treasures):
            ...
            if outcome == "treasure":
                    ...
                    print(f"You have found a {treasure}")
            else:
                    player["health"]-=2
                    print("Warning: That was a Trap! You have lost 2 health. Be Careful!")
            print()
    ...
    def check_status(player):
            ...
            print(f"Inventory: {"You have no items yet." if len(player["inventory"])== 0 else ", ".join(player["inventory"])}")
            print()
    ...
    def end_game(player, treasures):
            ...
            print(f"Your Inventory: {"You got no treasure." if len(player["inventory"])== 0 else ", ".join(player["inventory"])}")
    ...
    def run_game_loop(player, treasures):
            ...
            for room_number in range(1, 6):
                while True:
                    ...
                    player_choice=input("Enter the number for your choice (1-4): ")
                    print()
